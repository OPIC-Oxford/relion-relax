...
src/apps/CMakeFiles/maingui.dir/maingui.cpp.o: ../src/apps/maingui.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/users/strubi/serban/well/apps/relion-2.0-relax-patch/relion/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object src/apps/CMakeFiles/maingui.dir/maingui.cpp.o"
	cd /users/strubi/serban/well/apps/relion-2.0-relax-patch/relion/build/src/apps && /apps/well/openmpi/1.10.3-gcc5.4.0/bin/mpicxx   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/maingui.dir/maingui.cpp.o -c /users/strubi/serban/well/apps/relion-2.0-relax-patch/relion/src/apps/maingui.cpp
...
src/apps/CMakeFiles/maingui.dir/maingui.cpp.i: cmake_force
	...
	cd /users/strubi/serban/well/apps/relion-2.0-relax-patch/relion/build/src/apps && /apps/well/openmpi/1.10.3-gcc5.4.0/bin/mpicxx  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /users/strubi/serban/well/apps/relion-2.0-relax-patch/relion/src/apps/maingui.cpp > CMakeFiles/maingui.dir/maingui.cpp.i
...
src/apps/CMakeFiles/maingui.dir/maingui.cpp.s: cmake_force
	...
	cd /users/strubi/serban/well/apps/relion-2.0-relax-patch/relion/build/src/apps && /apps/well/openmpi/1.10.3-gcc5.4.0/bin/mpicxx  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /users/strubi/serban/well/apps/relion-2.0-relax-patch/relion/src/apps/maingui.cpp -o CMakeFiles/maingui.dir/maingui.cpp.s
...
bin/relion_maingui: /apps/well/openmpi/1.10.3-gcc5.4.0/lib/libmpi_cxx.so
bin/relion_maingui: /apps/well/openmpi/1.10.3-gcc5.4.0/lib/libmpi.so
bin/relion_maingui: /usr/lib64/libdl.so
bin/relion_maingui: /usr/lib64/libm.so
bin/relion_maingui: /usr/lib64/librt.so
bin/relion_maingui: /usr/lib64/libnsl.so
bin/relion_maingui: /usr/lib64/libutil.so
bin/relion_maingui: /usr/lib64/libm.so
bin/relion_maingui: /usr/lib64/libdl.so
...
bin/relion_maingui: src/apps/CMakeFiles/maingui.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/users/strubi/serban/well/apps/relion-2.0-relax-patch/relion/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/relion_maingui"
	cd /users/strubi/serban/well/apps/relion-2.0-relax-patch/relion/build/src/apps && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/maingui.dir/link.txt --verbose=$(VERBOSE)
	cd /users/strubi/serban/well/apps/relion-2.0-relax-patch/relion/build/src/apps && /gpfs0/apps/well/cmake/3.7.2/bin/cmake -E copy /users/strubi/serban/well/apps/relion-2.0-relax-patch/relion/build/bin/relion_maingui /users/strubi/serban/well/apps/relion-2.0-relax-patch/relion/build/bin/relion
	cd /users/strubi/serban/well/apps/relion-2.0-relax-patch/relion/build/src/apps && /gpfs0/apps/well/cmake/3.7.2/bin/cmake -E copy /users/strubi/serban/well/apps/relion-2.0-relax-patch/relion/build/bin/relion_qsub.csh /users/strubi/serban/well/apps/relion-2.0-relax-patch/relion/build/bin/qsub.csh
